...
VALIDATION_COMMANDS = [
    ...
    r"python .\skills\erie-hls-generator\scripts\python\validation\confidence_loop.py --server <remote-hls-validation-primary> --vitis-version <configured-vitis-version> --readiness cosim --remote-parallelism 3 --json-out .\reports\confidence-loop\latest-remote.json",
]
