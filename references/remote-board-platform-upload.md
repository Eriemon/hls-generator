...
- Governed project root: `~/workspace/readable-hls-generator/`
- Governed platform root:
  `~/workspace/readable-hls-generator/platforms/alveo/xilinx_u55c_gen3x16_xdma_3_202210_1/`
- Expected XPFM path:
  `~/workspace/readable-hls-generator/platforms/alveo/xilinx_u55c_gen3x16_xdma_3_202210_1/xilinx_u55c_gen3x16_xdma_3_202210_1.xpfm`
...
4. Rerun board validation with explicit board platform arguments so the
   selection is written back to `~/.readable-hls-generator/config.json`.
