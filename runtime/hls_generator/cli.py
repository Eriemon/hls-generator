...
from .readability_gate.rewrite_plan import (
...
from .validation import READINESS_LEVELS, ValidationRunOptions, validate_generated
from .workflow import WorkflowRunRequest, run_workflow
...
def _require_resolved_comment_language(comment_language: str) -> str:
    ...
    if str_resolved_language is None:
        ...
        raise ValueError(
            ...
            "`python -m runtime.hls_generator user-config "
...
def _require_dependencies_for_use(
    ...
    *,
    ...
    raise ValueError(
        ...
        "Run `python -m runtime.hls_generator deps request --out <path>` "
        "or inspect the generated dependency request file."
    )

# 模块以 `python -m runtime.hls_generator.cli` 方式运行时走统一入口。
